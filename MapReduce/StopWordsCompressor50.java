...
public class StopWordsCompressor50 extends Configured implements Tool {
	  public static void main(String[] args) throws Exception {
		    int res = ToolRunner.run(new StopWordsCompressor50(), args);
		    System.exit(res);
		  }
	  ...
	  @Override
	   public int run(String[] args) throws Exception {
	      ...
	      Job job = new Job(getConf(), "StopWordsCompressor50");
	      Configuration Conf = new Configuration();
	      
	      job.setJarByClass(StopWordsCompressor50.class);
