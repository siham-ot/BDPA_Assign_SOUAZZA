...
public class StopWordsCompressor extends Configured implements Tool {
	  public static void main(String[] args) throws Exception {
		    int res = ToolRunner.run(new StopWordsCompressor(), args);
		    System.exit(res);
		  }
	  ...
	  @Override
	   public int run(String[] args) throws Exception {
	      ...
	      Job job = new Job(getConf(), "StopWordsCompressor");
	      Configuration Conf = new Configuration();
	      
	      job.setJarByClass(StopWordsCompressor.class);
